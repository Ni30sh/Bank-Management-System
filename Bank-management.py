...
open_btn = Button(firstframe1,text="OPEN \n\n ACCOUNT", font=("Microsoft", 12, "bold"), borderwidth=3, activeforeground="blue",
                  activebackground="white", command=open_account, relief="flat")
open_btn.place(x=150, y=50, height=130, width=150)
DePosite_btn = Button(firstframe1, font=("Microsoft", 12, "bold"), text="DEPOSIT \n\n AMOUNT ",borderwidth=3, relief="flat",
                      activeforeground="blue",
                      activebackground="white", command=deposit_money)
DePosite_btn.place(x=150, y=230, height=130, width=150)
WDL_btn = Button(firstframe1, font=("Microsoft", 12, "bold"), text="WITHDRAWAL \n\n AMOUNT",borderwidth=3, relief="flat", activeforeground="blue",
                 activebackground="white", command=WITHDRAWAL_money)
WDL_btn.place(x=480, y=50, height=130, width=150)
SB_btn = Button(firstframe1, font=("Microsoft", 12, "bold"), borderwidth=3,text="SHOW \n\n BALANCE", activeforeground="blue", relief="flat",
                activebackground="white", command=show_balance)
...
timer()
database_button = Button(qwe, text=" DATABASE ", font=('chiller', 13, 'italic bold'),
                         activeforeground="black",activebackground="red", command=connect_database)
